...
// --- CONFIGURAÇÕES DA JANELA DESKTOP TELA CHEIA ---
        ...
        JPanel painelPrincipal = new JPanel(new BorderLayout(10, 20)) {
            ...
            protected void paintComponent(Graphics g) {
                ...
                // Desenhos abstratos de fundo (mantidos)
        ...
        // Ajustado o recuo do topo para equilibrar com os textos maiores
        ...
        // Ícone ligeiramente maior para acompanhar o novo título
        JPanel painelIcone = new JPanel() {
            ...
            protected void paintComponent(Graphics g) {
                ...
                int w = getWidth();
                int h = getHeight();
                int tamanhoIcone = 70; // Aumentado de 60 para 70
        ...
        // MODIFICAÇÃO: Título bem mais imponente
        JLabel titulo = new JLabel("Sistema de Feedback");
        titulo.setFont(new Font("Segoe UI", Font.BOLD, 46)); // Aumentado de 38 para 46
        titulo.setForeground(new Color(33, 37, 41));
        titulo.setAlignmentX(Component.CENTER_ALIGNMENT);

        // MODIFICAÇÃO: Subtítulo maior e com mais destaque
        JLabel subtitulo = new JLabel("Escolha como deseja acessar a plataforma");
        subtitulo.setFont(new Font("Segoe UI", Font.PLAIN, 20)); // Aumentado de 16 para 20
        ...
        // --- BOTÕES ---
        // MODIFICAÇÃO: Aumentado o espaçamento vertical entre os botões para 18
        JPanel painelBotoes = new JPanel(new GridLayout(3, 1, 0, 18));
        ...
        JButton login = criarBotaoInterativo("Fazer Login", corLogin, corLoginHover);
        login.addActionListener(e -> {
            LoginDisplay loginDisplay = new LoginDisplay();
            loginDisplay.setVisible(true);
        });

        JButton cadastro = criarBotaoInterativo("Criar Conta", corCadastro, corCadastroHover);
        ...
        anonimo.addActionListener(e -> {
            ...
            anonimoDisplay.setVisible(false);
        ...
        JPanel cardCentral = new JPanel(new BorderLayout()) {
            ...
            protected void paintComponent(Graphics g) {
                ...
                g2.setColor(Color.WHITE);
                g2.fillRoundRect(0, 0, getWidth(), getHeight(), 28, 28); // Cantos ligeiramente mais arredondados
        ...
        centralizador.setBackground(corFundoApp);
        centralizador.setOpaque(false);

        // MODIFICAÇÃO: Expandido o tamanho do Card. Agora os botões ganham muito mais largura e altura livre.
        cardCentral.setPreferredSize(new Dimension(460, 340));
    ...
    private JButton criarBotaoInterativo(String texto, Color corBase, Color corHover) {
        ...
        // MODIFICAÇÃO: Fonte interna dos botões aumentada de 14 para 18
    ...
    class BotaoModerno extends JButton {
        ...
        private int raioBorda = 18; // Bordas ligeiramente mais suaves acompanhando o crescimento do botão
